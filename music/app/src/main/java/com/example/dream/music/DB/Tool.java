package com.example.dream.music.DB;
...
public class Tool {
    public static List<MusicDb> getMusicList(Context context){
        List<MusicDb> musicList = new ArrayList<>();
        ContentResolver resolver = context.getContentResolver();
        Cursor cursor = resolver.query(MediaStore.Audio.Media.EXTERNAL_CONTENT_URI, null, null, null, null);
        if(cursor.moveToFirst()){
            do{
                MusicDb musicItem = new MusicDb();
